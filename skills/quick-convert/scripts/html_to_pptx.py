...
sys.path.insert(0, str(_root / "pptx-builder" / "scripts"))
sys.path.insert(0, str(_root / "standardize" / "scripts"))
sys.path.insert(0, str(_root / "triage" / "scripts"))
sys.path.insert(0, str(_root / "prep" / "scripts"))
